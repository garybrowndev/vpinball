...
float3 anaglyph(const float3 L, const float3 R)
{
	...
	[branch] if (ms_zpd_ya_td.w == 5.0 || ms_zpd_ya_td.w == 12.0) // Anaglyph 3D Red/Cyan
		return pow(abs(float3(LMA.r,RMA.g,RMA.b)), 1./Anaglyph_DeSaturation_Contrast.y); //!! Contrast is meh here
	[branch] if (ms_zpd_ya_td.w == 6.0 || ms_zpd_ya_td.w == 13.0) // Anaglyph 3D Green/Magenta
		return pow(abs(float3(RMA.r,LMA.g,RMA.b)), 1./Anaglyph_DeSaturation_Contrast.y); //!! Contrast is meh here
	[branch] if (ms_zpd_ya_td.w == 7.0 || ms_zpd_ya_td.w == 14.0) // Anaglyph 3D Dubois Red/Cyan
	{
		...
		return saturate(pow(abs(float3(r,g,b)), 1./Anaglyph_DeSaturation_Contrast.y)); //!! Contrast is meh here
	}
